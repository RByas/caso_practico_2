...
def demo_country():
    ...
    r = ctrl.create("el pais de la maravilla")
    print_response("CREATE", r)
    new_id = r["data"]["country_id"] if r["status"] == "success" else None

    if new_id:
        r = ctrl.update(new_id, "País maravilla Actualizado")
...
def demo_customer():
    ...
    if new_id:
        # UPDATE
        r = ctrl.update(new_id, first_name="Roberto", email="roberto@test.com")
        print_response("UPDATE", r)
